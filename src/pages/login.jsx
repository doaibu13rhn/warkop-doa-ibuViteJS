  ...
  return (
    <>
      <main className="flex">
        ...
        <section className="right bg-[url(./assets/images/login-page-bg.webp)] bg-no-repeat bg-cover md:bg-[center_top_32%] lg:bg-none px-[15px] lg:px-[0px] pt-[30px] lg:pt-[19vh] pb-[14.5vh] w-[100%] lg:w-[50%]">
          ...
          <section className="register-form flex flex-col gap-[25px]">
            ...
            <p className="have-account text-center text-white lg:text-black">
              Not Have An Account?
              <Link to="/register">
                <span className="login-link text-color-1">Register</span>
              </Link>
            </p>
